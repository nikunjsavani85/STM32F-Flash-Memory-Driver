...
/* based on this decide time taken by erase sector */
...
/* PSIZE decide based on voltage range EX: (FLASH_CR 8,9 Bit-filed ) FLASH_TYPEPROGRAM_BYTE << 8 */
...
/* write/erase data during flash and its depend on voltage range (FLASH_CR 8,9 Bit-filed) */
